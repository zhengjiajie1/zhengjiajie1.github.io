        ...
        <app-body>
            <div class="idle-details-container">
                <div class="details-header">
                    ...
                    <div class="details-header-buy" :style="'width:'+(isMaster?'300px;':'500px;')">
                        <div style="color: red;font-size: 32px;font-weight: 600;margin-right: 20px">￥{{idleItemInfo.idlePrice}}</div>
